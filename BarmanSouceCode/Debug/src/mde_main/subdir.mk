...
CPP_DEPS += \
./src/mde_main/mde_main.d 

OBJS += \
./src/mde_main/mde_main.o 


# Each subdirectory must supply rules for building sources it contributes
src/mde_main/%.o: ../src/mde_main/%.cpp src/mde_main/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-mde_main

clean-src-2f-mde_main:
	-$(RM) ./src/mde_main/mde_main.d ./src/mde_main/mde_main.o

.PHONY: clean-src-2f-mde_main
